...
def _get_magnitudes_and_multiplicities(
    min_magnitude: float, max_magnitude: float, unit_cell: UnitCell
    ...
    while i < len(reciprocal_lattice_vectors) - 1:
        ...
        while i < len(reciprocal_lattice_vectors) - 1 and np.isclose(
            ...
            reciprocal_lattice_vectors[i] = (
                reciprocal_lattice_vector,
                magnitude,
                reciprocal_lattice_vectors[i][2] + reciprocal_lattice_vectors[i + 1][2],
            )
