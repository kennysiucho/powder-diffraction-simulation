...
class UnitCellV2:
    ...
    ----------
        - material (str): The chemical formula of the crystal, e.g. "NaCl".
        - lattice_constants (ndarray): The side lengths (a, b, c) of the unit cell in
        the (x, y, z) directions respectively, given in nanometers (nm).
        - atoms(ndarray): A list of the atoms in the unit cell, represented as a
        structured NumPy array. This array must have fields "atomic_numbers" and
        "positions".
    ...
    def new_unit_cell(
        ...
        Returns an instance of `UnitCellV2` given the parameters of the lattice and the
        basis.
        ...
        Returns
        -------
            - (UnitCellV2): An instance of `UnitCellV2`, which represents the unit cell
            of the crystal.
            - (None): If an error is encountered, the function returns None and raises
            an error.
