...
def test_monte_carlo_calculate_diffraction_pattern(nd_monte_carlo, mocker):
    ...
    mocker.patch("B8_project.utils.random_uniform_unit_vectors",
    ...
    expected_two_thetas = np.array(
        [162.63819148, 65.67386965, 16.90391563, 83.593794, 83.70605006,
         90.91048647, 7.53356425, 44.00035372, 79.02876523, 158.61472377])
    expected_intensities = np.array(
        [2.489788e-05, 3.136013e-02, 7.809854e-02, 2.148601e-06,
